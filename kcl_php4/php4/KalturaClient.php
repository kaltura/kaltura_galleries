...
define("KalturaAuditTrailFileSyncType_FILE", 1);
define("KalturaAuditTrailFileSyncType_LINK", 2);
define("KalturaAuditTrailFileSyncType_URL", 3);
...
define("KalturaBitRateMode_CBR", 1);
define("KalturaBitRateMode_VBR", 2);
...
define("KalturaDistributionProviderType_IDETIC", "ideticDistribution.IDETIC");
define("KalturaDistributionProviderType_MYSPACE", "myspaceDistribution.MYSPACE");
...
define("KalturaPartnerStatus_ACTIVE", 1);
define("KalturaPartnerStatus_BLOCKED", 2);
define("KalturaPartnerStatus_FULL_BLOCK", 3);
...
define("KalturaStorageServePriority_KALTURA_ONLY", 1);
define("KalturaStorageServePriority_KALTURA_FIRST", 2);
define("KalturaStorageServePriority_EXTERNAL_FIRST", 3);
define("KalturaStorageServePriority_EXTERNAL_ONLY", 4);
...
define("KalturaTrackEntryEventType_UPLOADED_FILE", 1);
define("KalturaTrackEntryEventType_WEBCAM_COMPLETED", 2);
define("KalturaTrackEntryEventType_IMPORT_STARTED", 3);
define("KalturaTrackEntryEventType_ADD_ENTRY", 4);
define("KalturaTrackEntryEventType_UPDATE_ENTRY", 5);
define("KalturaTrackEntryEventType_DELETED_ENTRY", 6);
...
class KalturaContentDistributionSearchItem extends KalturaSearchItem
{
	 ...
	 * @var bool
	 */
	var $noDistributionProfiles = null;
	 ...
	 */
	var $distributionSunStatus = null;
	 ...
	 */
	var $entryDistributionFlag = null;
	 ...
	 */
	var $entryDistributionStatus = null;
	 ...
	 * @var bool
	 */
	var $hasEntryDistributionValidationErrors = null;
	 ...
	 * @var string
	 */
	var $entryDistributionValidationErrors = null;
...
class KalturaSystemPartnerConfiguration extends KalturaObjectBase
{
	 ...
	 * @var bool
	 */
	var $storageDeleteFromKaltura = null;
	 ...
	 * @var bool
	 */
	var $enableContentDistribution = null;
	 ...
	 * @var bool
	 */
	var $enablePs2PermissionValidation = null;
	 ...
	 * @var string
	 */
	var $alwaysAllowedPermissionNames = null;
...
class KalturaSystemPartnerService extends KalturaServiceBase
{
	...
	function get($partnerId)
	{
		$kparams = array();
		$this->client->addParam($kparams, "partnerId", $partnerId);
		$resultObject = $this->client->callService("systempartner", "get", $kparams);
		$this->client->checkForError($resultObject);
		$this->client->validateObjectType($resultObject, "KalturaPartner");
		return $resultObject;
	}

	function getUsage($partnerFilter = null, $usageFilter = null, $pager = null)
	{
		$kparams = array();
		...
		if ($pager !== null)
			$this->client->addParam($kparams, "pager", $pager->toParams());
		$resultObject = $this->client->callService("systempartner", "getUsage", $kparams);
		$this->client->checkForError($resultObject);
	...
	function listAction($filter = null, $pager = null)
	{
		...
		if ($pager !== null)
			$this->client->addParam($kparams, "pager", $pager->toParams());
		$resultObject = $this->client->callService("systempartner", "list", $kparams);
		$this->client->checkForError($resultObject);
	...
	function updateStatus($partnerId, $status)
	{
		...
		$this->client->addParam($kparams, "partnerId", $partnerId);
		$this->client->addParam($kparams, "status", $status);
		$resultObject = $this->client->callService("systempartner", "updateStatus", $kparams);
		$this->client->checkForError($resultObject);
		$this->client->validateObjectType($resultObject, "null");
		return $resultObject;
	}
	...
	function getAdminSession($partnerId, $userId = "")
	{
		...
		$this->client->addParam($kparams, "partnerId", $partnerId);
		$this->client->addParam($kparams, "userId", $userId);
		$resultObject = $this->client->callService("systempartner", "getAdminSession", $kparams);
		$this->client->checkForError($resultObject);
		$this->client->validateObjectType($resultObject, "string");
		return $resultObject;
	}

	function updateConfiguration($partnerId, $configuration)
	{
		$kparams = array();
		$this->client->addParam($kparams, "partnerId", $partnerId);
		$this->client->addParam($kparams, "configuration", $configuration->toParams());
		$resultObject = $this->client->callService("systempartner", "updateConfiguration", $kparams);
		$this->client->checkForError($resultObject);
		$this->client->validateObjectType($resultObject, "null");
		return $resultObject;
	}
	...
	function getConfiguration($partnerId)
	{
		$kparams = array();
		$this->client->addParam($kparams, "partnerId", $partnerId);
		$resultObject = $this->client->callService("systempartner", "getConfiguration", $kparams);
		$this->client->checkForError($resultObject);
	...
	{
		$kparams = array();
		$resultObject = $this->client->callService("systempartner", "getPackages", $kparams);
		$this->client->checkForError($resultObject);
		$this->client->validateObjectType($resultObject, "array");
		return $resultObject;
	}
...
class KalturaFlavorParamsOutputService extends KalturaServiceBase
{
	...
	function listAction($filter = null, $pager = null)
	{
		...
		if ($pager !== null)
			$this->client->addParam($kparams, "pager", $pager->toParams());
		$resultObject = $this->client->callService("flavorparamsoutput", "list", $kparams);
		$this->client->checkForError($resultObject);
...
class KalturaThumbParamsOutputService extends KalturaServiceBase
{
	...
	function listAction($filter = null, $pager = null)
	{
		...
		if ($pager !== null)
			$this->client->addParam($kparams, "pager", $pager->toParams());
		$resultObject = $this->client->callService("thumbparamsoutput", "list", $kparams);
		$this->client->checkForError($resultObject);
...
class KalturaMediaInfoService extends KalturaServiceBase
{
	...
	function listAction($filter = null, $pager = null)
	{
		...
		if ($pager !== null)
			$this->client->addParam($kparams, "pager", $pager->toParams());
		$resultObject = $this->client->callService("mediainfo", "list", $kparams);
		$this->client->checkForError($resultObject);
...
class KalturaEntryAdminService extends KalturaServiceBase
{
	...
	function get($entryId, $version = -1)
	{
		...
		$this->client->addParam($kparams, "entryId", $entryId);
		$this->client->addParam($kparams, "version", $version);
		$resultObject = $this->client->callService("entryadmin", "get", $kparams);
		$this->client->checkForError($resultObject);
		$this->client->validateObjectType($resultObject, "KalturaBaseEntry");
		return $resultObject;
	}
	...
	function getByFlavorId($flavorId, $version = -1)
	{
		...
		$this->client->addParam($kparams, "version", $version);
		$resultObject = $this->client->callService("entryadmin", "getByFlavorId", $kparams);
		$this->client->checkForError($resultObject);
		$this->client->validateObjectType($resultObject, "KalturaBaseEntry");
		return $resultObject;
	}
	...
	function getTracks($entryId)
	{
		$kparams = array();
		$this->client->addParam($kparams, "entryId", $entryId);
		$resultObject = $this->client->callService("entryadmin", "getTracks", $kparams);
		$this->client->checkForError($resultObject);
...
class KalturaUiConfAdminService extends KalturaServiceBase
{
	...
	function add($uiConf)
	{
		$kparams = array();
		$this->client->addParam($kparams, "uiConf", $uiConf->toParams());
		$resultObject = $this->client->callService("uiconfadmin", "add", $kparams);
		$this->client->checkForError($resultObject);
		$this->client->validateObjectType($resultObject, "KalturaUiConf");
		return $resultObject;
	}
	...
	function update($id, $uiConf)
	{
		...
		$this->client->addParam($kparams, "id", $id);
		$this->client->addParam($kparams, "uiConf", $uiConf->toParams());
		$resultObject = $this->client->callService("uiconfadmin", "update", $kparams);
		$this->client->checkForError($resultObject);
		$this->client->validateObjectType($resultObject, "KalturaUiConf");
		return $resultObject;
	}
	...
	function get($id)
	{
		$kparams = array();
		$this->client->addParam($kparams, "id", $id);
		$resultObject = $this->client->callService("uiconfadmin", "get", $kparams);
		$this->client->checkForError($resultObject);
		$this->client->validateObjectType($resultObject, "KalturaUiConf");
		return $resultObject;
	}
	...
	function delete($id)
	{
		$kparams = array();
		$this->client->addParam($kparams, "id", $id);
		$resultObject = $this->client->callService("uiconfadmin", "delete", $kparams);
		$this->client->checkForError($resultObject);
		$this->client->validateObjectType($resultObject, "null");
		return $resultObject;
	}
...
class KalturaKalturaInternalToolsSystemHelperService extends KalturaServiceBase
{
	...
	function fromSecureString($str)
	{
		...
		$resultObject = $this->client->callService("kalturainternaltoolssystemhelper", "fromSecureString", $kparams);
		$this->client->checkForError($resultObject);
	...
	function iptocountry($remote_addr)
	{
		...
		$resultObject = $this->client->callService("kalturainternaltoolssystemhelper", "iptocountry", $kparams);
		$this->client->checkForError($resultObject);
		$this->client->validateObjectType($resultObject, "string");
		return $resultObject;
	}
	...
	{
		$kparams = array();
		$resultObject = $this->client->callService("kalturainternaltoolssystemhelper", "getRemoteAddress", $kparams);
		$this->client->checkForError($resultObject);
		$this->client->validateObjectType($resultObject, "string");
		return $resultObject;
	}
...
class KalturaClient extends KalturaClientBase
{
	 ...
	 */
	var $kalturaInternalToolsSystemHelper = null;
